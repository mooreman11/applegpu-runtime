...
impl KernelRegistry {
    ...
    pub fn resolve_kernel(base_name: &str, dtype: DType) -> (String, String) {
        ...
        let source = match base_name {
            ...
            "conv2d_backward_weight" => kt::conv2d_backward_weight_kernel_source(dtype),
            "embedding_backward" => kt::embedding_backward_kernel_source(dtype),
            "scatter_write" => kt::scatter_write_kernel_source(dtype),
            "scatter_add" => kt::scatter_add_kernel_source(dtype),
